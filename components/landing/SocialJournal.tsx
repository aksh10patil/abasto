...
const SOCIAL_POSTS = [
  {
    ...
    comments: 52,
    featuredComment:
      "@culinaryreview: You can feel the discipline behind the dish.",
  },
  {
    id: 2,
    type: "video",
    src: "/video3.mp4",
    caption:
      "Every movement intentional. Technique refined through repetition.",
    likes: "980",
    comments: 34,
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
                  <div className="text-center px-4 transform scale-95 group-hover:scale-100 transition-transform duration-300">
                    <p className="text-xs font-serif italic text-white mb-2">
                      "{post.caption}"
                    </p>
