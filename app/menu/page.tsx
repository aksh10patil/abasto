    ...
    items: [
      {
        ...
        price: "24",
        description:
          "Puglian burrata, vegetable charcoal, heirloom tomato essence, basil oil.",
      },
      {
        name: "Wagyu Carpaccio",
        price: "32",
        description:
          "A5 Miyazaki beef, truffle ponzu, pickled mustard seeds, cured yolk.",
      },
      {
        name: "Charred Octopus",
        price: "28",
        description:
          "Spanish octopus, romesco sauce, smoked potato foam, paprika oil.",
      },
      {
        name: "Wild Fungi Tart",
        price: "22",
        description:
          "Foraged seasonal mushrooms, thyme mascarpone, aged balsamic.",
        tags: ["V"],
      },
    ],
  },
    ...
    items: [
      {
        ...
        price: "34",
        description:
          "Acquerello rice, saffron pistils, 24-month Parmigiano Reggiano, bone marrow.",
        tags: ["GF"],
      },
      {
        name: "Truffle Tajarin",
        price: "45",
        description:
          "Hand-cut egg pasta, butter emulsion, shavings of fresh black winter truffle.",
      },
      {
        name: "Lobster Ravioli",
        price: "42",
        description:
          "Maine lobster filling, bisque reduction, tarragon, lemon zest.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        price: "48",
        description:
          "Dry-aged duck, cherry glaze, roasted endive, parsnip purée.",
      },
      {
        name: "Branzino al Sale",
        price: "52",
        description:
          "Whole salt-baked sea bass, fennel pollen, citrus vierge, grilled artichokes.",
        tags: ["GF"],
      },
      {
        ...
        price: "120",
        description:
          "40oz Porterhouse (serves two), rosemary smoke, Tuscan olive oil, sea salt.",
      },
    ],
  },
];
